...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!TRIN  
...
| Provider (seed) | Trinity Capital | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | BDC — confirm from 1099 | 2026 EST 5.0% — BDC — monthly dividend from earnings; low ROC expected. Planning 5%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for TRIN, read this file (+ related Authority packs).
