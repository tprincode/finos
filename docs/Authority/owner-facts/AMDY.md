...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!AMDY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | AMDY | book-cited |
| Underlying / sleeve (seed) | AMD | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 50% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 502.94 + ROC 289.84 → 36.6% | 2026 EST 50.0% — YieldMax weekly 19a-1 highly variable (0–97%); planning blend 50%. 2025 actual 36.6%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for AMDY, read this file (+ related Authority packs).
