...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!NVDW  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | NVDW | book-cited |
| Underlying / sleeve (seed) | NVDA | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 2.56 + ROC 78.47 → 96.8% | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for NVDW, read this file (+ related Authority packs).
