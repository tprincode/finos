...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!QYLD  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | QYLD | book-cited |
| Underlying / sleeve (seed) | Nasdaq-100 covered call | book-cited |
...
| Provider (seed) | Global X | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 80% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | FYE 10/31/2025 Form 8937: 84.09% ROC on listed dists; 2024 not loaded here | 2026 EST 80.0% — Global X historical high ROC; 2025 actual 84.1%. Planning 80%… | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for QYLD, read this file (+ related Authority packs).
