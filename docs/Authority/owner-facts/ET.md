...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!ET  
...
| Provider (seed) | Energy Transfer | book-cited |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for ET, read this file (+ related Authority packs).
