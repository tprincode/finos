...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!SWVXX  
...
| Provider (seed) | Schwab | book-cited |
...
| Seed notes (abbrev) | Schwab money-market (Acct 9); interest on dividend plan; ROC N/A treat 0 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for SWVXX, read this file (+ related Authority packs).
