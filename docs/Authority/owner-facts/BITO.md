...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!BITO  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | BITO | book-cited |
| Underlying / sleeve (seed) | BTC futures | book-cited |
...
| Provider (seed) | ProShares | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | Confirm from 1099 | 2026 EST 5.0% — ProShares futures RIC — distributions generally ordinary; ROC uncommon. Planning 5%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for BITO, read this file (+ related Authority packs).
