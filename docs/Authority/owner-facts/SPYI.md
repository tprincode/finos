...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!SPYI  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | SPYI | book-cited |
| Underlying / sleeve (seed) | S&P 500 | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 95% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 3.74 + ROC 70.01 → 94.9% | 2026 EST 95.0% — 19a-1 Jun 2026: 93% current / 95% YTD ROC (NEOS). 2025 actual 94.9%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for SPYI, read this file (+ related Authority packs).
