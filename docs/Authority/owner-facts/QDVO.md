...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!QDVO  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | QDVO | book-cited |
| Underlying / sleeve (seed) | Dividend + options | book-cited |
...
| Provider (seed) | Amplify | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 98% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 1.45 + ROC 4.70 → 76.4% | 2026 EST 98.0% — 19a-1 May 2026: 98% current & YTD ROC (Amplify). 2025 actual 76.4% — estimate may diverge at year-end. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for QDVO, read this file (+ related Authority packs).
