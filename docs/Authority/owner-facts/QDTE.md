...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!QDTE  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | QDTE | book-cited |
| Underlying / sleeve (seed) | Nasdaq-100 0DTE | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 257.93 + ROC 1139.56 → 81.5% | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for QDTE, read this file (+ related Authority packs).
