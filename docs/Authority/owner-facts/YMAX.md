...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!YMAX  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | YMAX | book-cited |
| Underlying / sleeve (seed) | Fund of YM ETFs | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 200.31 + ROC 208.96 → 51.1% | 2026 EST 50.0% — YieldMax universe recent ~23–70% ROC; 2025 actual 51.1%. Planning 50%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for YMAX, read this file (+ related Authority packs).
