...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!CRF  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | CRF | book-cited |
| Underlying / sleeve (seed) | U.S. equity CEF | book-cited |
...
| Provider (seed) | Cornerstone | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 87% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 6.84 + ROC 48.42 → 87.6% | 2026 EST 87.0% — 2025 fund character: ROC/(Ord+ROC)≈87% (matches Car 1099 87.6%). Cap gains separate. 2026: portion expected ROC; use 87% … | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for CRF, read this file (+ related Authority packs).
