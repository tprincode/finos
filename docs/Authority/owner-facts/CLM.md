...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!CLM  
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 89% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | CEF — confirm from 1099 | 2026 EST 89.0% — 2025 fund ROC/(Ord+ROC)≈89.5% (same method as CRF). Cap gains separate. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for CLM, read this file (+ related Authority packs).
