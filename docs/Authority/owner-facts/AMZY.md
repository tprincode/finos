...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!AMZY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | AMZY | book-cited |
| Underlying / sleeve (seed) | AMZN | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 40% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 107.19 + ROC 196.76 → 64.7% | 2026 EST 40.0% — YieldMax recent weeks often 0% ROC; 2025 actual 64.7%. Planning blend 40%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for AMZY, read this file (+ related Authority packs).
