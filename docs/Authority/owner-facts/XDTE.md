...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!XDTE  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | XDTE | book-cited |
| Underlying / sleeve (seed) | S&P 500 0DTE | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 119.55 + ROC 654.74 → 84.6% | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for XDTE, read this file (+ related Authority packs).
