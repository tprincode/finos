...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!XPAY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | XPAY | book-cited |
| Underlying / sleeve (seed) | S&P 500 Target 20 | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: ROC 17.16; ordinary near 0 → ~100% (matches design) | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for XPAY, read this file (+ related Authority packs).
