...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!ORC  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | ORC | book-cited |
| Underlying / sleeve (seed) | Agency MBS REIT | book-cited |
...
| Provider (seed) | Orchid Island | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | REIT — confirm from 1099 | 2026 EST 25.0% — Mortgage REIT — similar. Planning 25%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for ORC, read this file (+ related Authority packs).
