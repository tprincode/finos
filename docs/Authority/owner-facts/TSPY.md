...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!TSPY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | TSPY | book-cited |
| Underlying / sleeve (seed) | SPY-related | book-cited |
...
| Provider (seed) | TappAlpha | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 85% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | Confirm from 1099 | 2026 EST 85.0% — TappAlpha recent distribution ~82% ROC; earlier notices 92–100%. Planning 85%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for TSPY, read this file (+ related Authority packs).
