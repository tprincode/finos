...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!RDTE  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | RDTE | book-cited |
| Underlying / sleeve (seed) | Russell 2000 0DTE | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | 19a-1 estimates often ~100% ROC; enter final from 1099 | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for RDTE, read this file (+ related Authority packs).
