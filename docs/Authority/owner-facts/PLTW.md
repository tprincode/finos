...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!PLTW  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | PLTW | book-cited |
| Underlying / sleeve (seed) | PLTR | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 0.98 + ROC 51.08 → 98.1% | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for PLTW, read this file (+ related Authority packs).
