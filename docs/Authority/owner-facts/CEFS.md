...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!CEFS  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | CEFS | book-cited |
| Underlying / sleeve (seed) | CEF portfolio | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 70% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | CEF — confirm from 1099 | 2026 EST 70.0% — CEF managed distribution — ROC common; no clean 2026 19a-1. Planning 70% (lower confidence). | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for CEFS, read this file (+ related Authority packs).
