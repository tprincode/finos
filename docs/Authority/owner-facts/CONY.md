...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!CONY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | CONY | book-cited |
| Underlying / sleeve (seed) | COIN | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 23.16 + ROC 762.92 → 97.1% | 2026 EST 90.0% — YieldMax variable; 2025 actual 97.1%. Planning 90%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for CONY, read this file (+ related Authority packs).
