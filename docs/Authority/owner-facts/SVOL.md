...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!SVOL  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | SVOL | book-cited |
| Underlying / sleeve (seed) | Vol premium | book-cited |
...
| Provider (seed) | Simplify | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | Confirm from 1099 | 2026 EST 25.0% — Simplify Dec 2025 19a-1: ROC ≈26% of distribution. Planning 25%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for SVOL, read this file (+ related Authority packs).
