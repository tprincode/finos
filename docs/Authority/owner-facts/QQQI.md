...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!QQQI  
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 1.04 + ROC 155.28 → 99.3% | 2026 EST 98.0% — 19a-1 Jun 2026: 98% current / 99% YTD ROC (NEOS). 2025 actual 99.3%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for QQQI, read this file (+ related Authority packs).
