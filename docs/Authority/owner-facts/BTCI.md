...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!BTCI  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | BTCI | book-cited |
| Underlying / sleeve (seed) | BTC | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 94% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | Confirm from 1099 | 2026 EST 94.0% — NEOS 19a-1 Jun 2026: 94% current / 93% YTD ROC. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for BTCI, read this file (+ related Authority packs).
