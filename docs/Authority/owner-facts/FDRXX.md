...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!FDRXX  
...
| Seed notes (abbrev) | Fidelity HSA money-market (Health); interest on dividend plan; ROC N/A treat 0 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for FDRXX, read this file (+ related Authority packs).
