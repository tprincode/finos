...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!AMDW  
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 4.79 + ROC 73.72 → 93.9% | 2026 EST (19a-1): 100.0% — final on 2027 1099 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for AMDW, read this file (+ related Authority packs).
