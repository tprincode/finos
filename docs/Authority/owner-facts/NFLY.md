...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!NFLY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | NFLY | book-cited |
| Underlying / sleeve (seed) | NFLX | book-cited |
...
| Seed notes (abbrev) | AUTHORITATIVE — Car 1099 2025: Ord 13.51 + ROC 5.56 → 29.2% | 2026 EST 85.0% — YieldMax weekly 19a-1 Jul 2026: recent ROC 87–90% (one week 0%). Highly variable; 85% planning blend. 2025 actual 29.2%. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for NFLY, read this file (+ related Authority packs).
