...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!IGLD  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | IGLD | book-cited |
| Underlying / sleeve (seed) | Gold-related | book-cited |
...
| Provider (seed) | FT Vest | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 59% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | Confirm from 1099 | 2026 EST 59.0% — FY2025 character ~59% ROC (Seeking Alpha / fund disclosures). No clean 2026 19a-1; use 59% prior. | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for IGLD, read this file (+ related Authority packs).
