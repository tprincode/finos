...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!JEPQ  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | JEPQ | book-cited |
| Underlying / sleeve (seed) | Nasdaq-100 | book-cited |
...
| Provider (seed) | JPMorgan | book-cited |
...
| Seed notes (abbrev) | Fill roc_pct from 1099 / year-end tax docs | ELN structure; distributions generally ordinary income (ROC ~0). Confirm 1099 | 2026 EST 5.0% — JPMorgan ELN structure — primarily ordinary income; small R… | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for JEPQ, read this file (+ related Authority packs).
