...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!MSTY  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | MSTY | book-cited |
| Underlying / sleeve (seed) | MSTR | book-cited |
...
| Provider (seed) | YieldMax | book-cited |
...
| Field | Value | Notes |
|-------|-------|-------|
| In-year ROC estimate (seed) | 90% | Book SoR via seed/`position_characteristic`; change only via Accept / `roc_pct_change` |
...
| Seed notes (abbrev) | Car 1099 2025: ROC Box3 = $484.97; ordinary subtotal not fully paired — enter ROC% after confirming Ord on 1099 | 2026 EST 90.0% — YieldMax recent often ~90–97% ROC. 2025 had substantial Box3. Plannin… | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for MSTY, read this file (+ related Authority packs).
