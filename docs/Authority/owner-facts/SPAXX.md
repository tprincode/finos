...
Scaffolded: 2026-09-16 from seed `Template_Positions` Data!SPAXX  
...
| Field | Value | Lock |
|-------|-------|------|
| Symbol | SPAXX | book-cited |
| Underlying / sleeve (seed) | US Gov MM | book-cited |
...
| Provider (seed) | Fidelity | book-cited |
| Frequency (seed) | Monthly | book-cited — confirm if live differs |
| Risk tier (seed) | Core | book-cited (Position Details) |
| Div type (seed) | CASH | book-cited |
| ROC scope | CASH (19a-1 N/A) | confirm on recreate if not CASH/MLP |
...
| Seed notes (abbrev) | Fidelity money-market; interest = dividend plan planned+actual; ROC N/A treat 0 | Context only |
...
1. Before asking about ROC / issuer / frequency / scope / amounts for SPAXX, read this file (+ related Authority packs).
