...
pub async fn withholding_get(pool: &SqlitePool) -> Result<i64, PlatformError> {
...
pub async fn projection(pool: &SqlitePool) -> Result<MagiProjection, PlatformError> {
    ...
    let rule = MagiRule {
        ...
        safety_reserve_minor: rule_row
            ...
            .map_err(|e| map_err(e.into()))?,
        scale: rule_row.try_get::<i64, _>("scale").map_err(|e| map_err(e.into()))? as u8,
    };
